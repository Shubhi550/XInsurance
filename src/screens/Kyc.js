        ...
        <div id="formContainer">
          <form id="form" action="#" method="POST" >
            <fieldset>
              ...
              <br />
              <div id="otherInputs">
                <input type="tel" name="PAN" id="PAN" placeholder="PAN Card" required /><br /> <br />
                <input type="tel" name="aadhar" id="aadhar" placeholder="Aadhar Card Number" required /><br /> <br />
                <input type="address" name="address" id="address" placeholder="Enter Your Address" required /><br /> <br />
